...
namespace ImageGlass
{
    public partial class frmMain : Form
    {
        ...
        private void frmMain_Load(object sender, EventArgs e)
        {
            ...
            btnRotateLeft.ToolTipText = "Rotate counterclockwise";
            btnRotateRight.ToolTipText = "Rotate clockwise";
            btnActualSize.ToolTipText = "Reset zoom";
            Text = "Image Viewer";
        }
